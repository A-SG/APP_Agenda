...
public class AgendaViewController implements Initializable {
    ...
    private void onActionButtonNuevo(ActionEvent event) {
        try{
                ...
                FXMLLoader fxmlLoader=new FXMLLoader(getClass().getResource("DetalleView.fxml"));
                Parent rootDetalleView=fxmlLoader.load();
                DetalleViewController personaDetalleViewController =(DetalleViewController) fxmlLoader.getController();
